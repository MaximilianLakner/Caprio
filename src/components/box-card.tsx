...
import { sizeOf, type Dachbox } from "@/lib/data";

export function BoxCard({ box }: { box: Dachbox }) {
  return (
    <Link
    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        {box.superhost && (
          <span className="absolute right-3 top-3 rounded-full bg-ink px-2.5 py-1 text-xs font-medium text-cream">
            Top-Vermieter
          </span>
        )}
      </div>
      ...
      <div className="p-5">
        ...
        <div className="mt-4 flex items-end justify-between border-t border-line pt-4">
          <p className="text-sm text-ink-soft">
            von {box.host} · seit {box.hostSince}
          </p>
